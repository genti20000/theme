...
interface FooterProps {
  // Updated type to include all possible page targets for better type safety
  onNavigate: (page: 'home' | 'menu' | 'drinks' | 'gallery' | 'imageEditor' | 'admin' | 'terms' | 'events' | 'blog' | 'songs' | 'sitemap' | 'instagram') => void;
}
