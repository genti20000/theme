            ...
            <div className="max-w-2xl mx-auto mb-10">
                <div className="relative">
                    <input 
                        ...
                        className="w-full bg-zinc-900 border border-zinc-700 rounded-full py-4 px-6 text-lg text-white focus:border-pink-500 focus:ring-1 focus:ring-pink-500 outline-none transition-all shadow-[0_0_20px_rgba(236,72,153,0.2)]"
                    />
