...
const BirthdayKaraokeSohoPage: React.FC = () => {
  const { birthdayPageData } = useData();
    ...
    <div className="bg-[#0A0A0A] text-white">
      ...
      <Section>
        ...
        <ul className="mb-6 grid gap-3 md:grid-cols-2">
          {(birthdayPageData.whyBullets || []).map((item) => (
        ...
        <p className="text-base leading-6 text-zinc-200 md:text-lg md:leading-7">{birthdayPageData.whyOutroA}</p>
        <p className="text-base leading-6 text-zinc-200 md:text-lg md:leading-7">{birthdayPageData.whyOutroB}</p>
      </Section>
      ...
      <Section className="border-t border-white/10">
        ...
        <p className="text-base leading-6 text-zinc-300 md:text-lg md:leading-7">{birthdayPageData.milestonesOutroA}</p>
        <p className="mt-4 text-base leading-6 text-zinc-200 md:text-lg md:leading-7">{birthdayPageData.milestonesOutroB}</p>
        <p className="mt-2 text-base leading-6 text-zinc-200 md:text-lg md:leading-7">{birthdayPageData.milestonesOutroC}</p>
      </Section>
      ...
      <Section className="border-t border-white/10">
        ...
        <p className="text-base leading-6 text-zinc-200 md:text-lg md:leading-7">{birthdayPageData.drinksNote}</p>
      </Section>
